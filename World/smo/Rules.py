...
def set_rules(self, options : SMOOptions) -> None:
    ...
    set_rule(self.multiworld.get_location("Luigi Suit", self.player), lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts["Luigi Suit"] or state.has("Luigi Suit", self.player))
    set_rule(self.multiworld.get_location("Doctor Headwear", self.player), lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts["Doctor Headwear"] or state.has("Doctor Headwear", self.player))
    set_rule(self.multiworld.get_location("Doctor Outfit", self.player), lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts["Doctor Outfit"] or state.has("Doctor Outfit", self.player))
    ...
    set_rule(self.multiworld.get_location("Waluigi Suit", self.player), lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts["Waluigi Suit"] or state.has("Waluigi Suit", self.player))
    set_rule(self.multiworld.get_location("Diddy Kong Hat", self.player), lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts["Diddy Kong Hat"] or state.has("Diddy Kong Hat", self.player))
    set_rule(self.multiworld.get_location("Diddy Kong Suit", self.player), lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts["Diddy Kong Suit"] or state.has("Diddy Kong Suit", self.player))
    ...
    set_rule(self.multiworld.get_location("Wario Suit", self.player), lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts["Wario Suit"] or state.has("Wario Suit", self.player))
    set_rule(self.multiworld.get_location("Hakama", self.player), lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts["Hakama"] or state.has("Hakama", self.player))
    set_rule(self.multiworld.get_location("Bowser's Top Hat", self.player), lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts["Bowser's Top Hat"] or state.has("Bowser's Top Hat", self.player))
    set_rule(self.multiworld.get_location("Bowser's Tuxedo", self.player), lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts["Bowser's Tuxedo"] or state.has("Bowser's Tuxedo", self.player))
    set_rule(self.multiworld.get_location("Bridal Veil", self.player), lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts["Bridal Veil"] or state.has("Bridal Veil", self.player))
    set_rule(self.multiworld.get_location("Bridal Gown", self.player), lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts["Bridal Gown"] or state.has("Bridal Gown", self.player))
