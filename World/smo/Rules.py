...
def set_rules(self, options : SMOOptions) -> None:
    ...
    if self.options.goal > 14:
        set_rule(self.multiworld.get_location("Caveman Cave-Fan", self.player),
                 lambda state: state.has("Primitive Man Cap", self.player) and state.has("Primitive Man Clothes",                                                                             self.player))
        set_rule(self.multiworld.get_location("That Trendy “Pirate” Look", self.player),
                 lambda state: state.has("Pirate Cap", self.player) and state.has("Pirate Clothes", self.player))
        set_rule(self.multiworld.get_location("Space Is “In” Right Now", self.player),
                 lambda state: state.has("Space Suit Cap", self.player) and state.has("Space Suit Clothes",                                                                         self.player))
        set_rule(self.multiworld.get_location("That “Old West” Style", self.player),
                 lambda state: state.has("Gunman Cap", self.player) and state.has("Gunman Clothes", self.player))
        set_rule(self.multiworld.get_location("Mechanic: Repairs Complete!", self.player),
                 lambda state: state.has("Mechanic Cap", self.player) and state.has("Mechanic Clothes", self.player))
        set_rule(self.multiworld.get_location("Doctor in the House", self.player),
                 lambda state: state.has("Doctor Cap", self.player) and state.has("Doctor Clothes", self.player))
        set_rule(self.multiworld.get_location("Totally Classic", self.player),
                 lambda state: (state.has("64 Cap", self.player) and state.has("64 Clothes", self.player)) or (
                             state.has("64 Metal Cap", self.player) and state.has("64 Metal Clothes", self.player)))
        ...
        set_rule(self.multiworld.get_location("Surprise Clown!", self.player),
                 lambda state: state.has("Clown Cap", self.player) and state.has("Clown Clothes", self.player))
    ...
    if self.options.goal > 5:
        set_rule(self.multiworld.get_location("I Feel Underdressed", self.player), lambda state: (state.has(
            "Swimwear Cap", self.player) and state.has("Swimwear Clothes", self.player)) or state.has("Underwear",
                                                                                                      self.player))
        set_rule(self.multiworld.get_location("Exploring for Treasure", self.player),
                 lambda state: state.has("Explorer Cap", self.player) and state.has("Explorer Clothes", self.player))


    if self.options.goal > 9:
        set_rule(self.multiworld.get_location("Rewiring the Neighborhood", self.player),
                 lambda state: state.has("Maker Cap", self.player) and state.has("Maker Clothes", self.player))
        set_rule(self.multiworld.get_location("A Relaxing Dance", self.player),
                 lambda state: state.has("Aloha Cap", self.player) and state.has("Aloha Clothes", self.player))
        set_rule(self.multiworld.get_location("Moon Shards in the Cold Room", self.player),
                 lambda state: state.has("Snow Suit Cap", self.player) and state.has("Snow Suit Clothes", self.player))
        ...
        set_rule(self.multiworld.get_location("I'm Not Cold!", self.player),
                 lambda state: state.has("Underwear", self.player))

    if self.options.goal > 12:
        set_rule(self.multiworld.get_location("A Strong Simmer", self.player),
                 lambda state: state.has("Cook Cap", self.player) and state.has("Cook Clothes", self.player))
    ...
    if self.options.goal > 14:
        set_rule(self.multiworld.get_location("Scene of Crossing the Poison Swamp", self.player),
                 lambda state: state.has("Armor Cap", self.player) and state.has("Armor Clothes", self.player))
    ...
    if self.options.goal > 14:
        ...
        set_rule(self.multiworld.get_location("Luigi Clothes", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Luigi Clothes"] or state.has("Luigi Clothes", self.player))
        set_rule(self.multiworld.get_location("Doctor Cap", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Doctor Cap"] or state.has("Doctor Cap", self.player))
        set_rule(self.multiworld.get_location("Doctor Clothes", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Doctor Clothes"] or state.has("Doctor Clothes", self.player))
        set_rule(self.multiworld.get_location("Waluigi Cap", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Waluigi Cap"] or state.has("Waluigi Cap", self.player))
        set_rule(self.multiworld.get_location("Waluigi Clothes", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Waluigi Clothes"] or state.has("Waluigi Clothes", self.player))
        set_rule(self.multiworld.get_location("Diddy Kong Cap", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Diddy Kong Cap"] or state.has("Diddy Kong Cap", self.player))
        set_rule(self.multiworld.get_location("Diddy Kong Clothes", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Diddy Kong Clothes"] or state.has("Diddy Kong Clothes", self.player))
        set_rule(self.multiworld.get_location("Wario Cap", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Wario Cap"] or state.has("Wario Cap", self.player))
        set_rule(self.multiworld.get_location("Wario Clothes", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Wario Clothes"] or state.has("Wario Clothes", self.player))
        set_rule(self.multiworld.get_location("Hakama Clothes", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Hakama Clothes"] or state.has("Hakama Clothes", self.player))
        set_rule(self.multiworld.get_location("Koopa Cap", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Koopa Cap"] or state.has("Koopa Cap", self.player))
        set_rule(self.multiworld.get_location("Koopa Clothes", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Koopa Clothes"] or state.has("Koopa Clothes", self.player))
        set_rule(self.multiworld.get_location("Peach Cap", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Peach Cap"] or state.has("Peach Cap", self.player))
        set_rule(self.multiworld.get_location("Peach Clothes", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Peach Clothes"] or state.has("Peach Clothes", self.player))
        set_rule(self.multiworld.get_location("Gold Cap", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Gold Cap"] or state.has("Gold Cap", self.player))
        set_rule(self.multiworld.get_location("Gold Clothes", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "Gold Clothes"] or state.has("Gold Clothes", self.player))
        set_rule(self.multiworld.get_location("64 Metal Cap", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "64 Metal Cap"] or state.has("64 Metal Cap", self.player))
        set_rule(self.multiworld.get_location("64 Metal Clothes", self.player),
                 lambda state: total_moons(self, state, self.player) >= self.outfit_moon_counts[
                     "64 Metal Clothes"] or state.has("64 Metal Clothes", self.player))
